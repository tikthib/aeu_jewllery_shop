...
<div id="default-carousel" class="relative w-full" data-carousel="slide">
    <!-- Carousel wrapper -->
    <div class="relative h-auto overflow-hidden  rounded-lg md:h-[88vh]">
         <!-- Item 1 -->
         <!-- <img src="https://images-aka.kayoutlet.com/kayoutlet/homepage/FY25/4.18/KO-4-18-Homepage-DT-Hero-25-70-Off-Rings-Necklaces-Earrings.png" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..."> -->
